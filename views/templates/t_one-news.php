...
<div id="highlighted">
    <div class="container">
        <div class="header">
            <h2 class="page-title">
                <span><?php echo htmlspecialchars($new['title']); ?></span>
            </h2>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 blog-post">
                <!--Main blog post-->
                <div class="media">
                    <img src="/uploads/news/<?php echo htmlspecialchars($new['photo_filename']); ?>" alt="<?php echo htmlspecialchars($new['title']); ?>" class="media-object" />
                    <div class="media-body">
                        <h1><?php echo htmlspecialchars($new['title']); ?></h1>
                        <!-- Meta details -->
                        ...
                        <p class="lead"><?php echo htmlspecialchars($new['description']); ?></p>
                    </div>
                </div>
                <div class="media">
